...
package com.zykj.benditong.swiptodelete;
 ...
 */
@SuppressLint("NewApi") @TargetApi(Build.VERSION_CODES.HONEYCOMB_MR1) public class SwipeDismissTouchListener implements View.OnTouchListener {
    ...
    @SuppressLint("NewApi") @TargetApi(Build.VERSION_CODES.HONEYCOMB_MR1) @Override
