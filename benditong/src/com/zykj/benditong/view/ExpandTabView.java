...
public class ExpandTabView extends LinearLayout implements OnDismissListener {
	...
	private ArrayList<ToggleButton> mToggleButton = new ArrayList<ToggleButton>();//菜单
	private ArrayList<RelativeLayout> mViewArray = new ArrayList<RelativeLayout>();//菜单列表
	...
	public void setValue(ArrayList<String> textArray, ArrayList<View> viewArray) {
		...
		for (int i = 0; i < viewArray.size(); i++) {
			...
			line.setBackgroundColor(getResources().getColor(R.color.lgrey));
