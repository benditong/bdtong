...
public class AssessListActivity extends BaseActivity implements IXListViewListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new CommonAdapter<Assess>(AssessListActivity.this, R.layout.ui_item_assess, assesslist) {
			@Override
			public void convert(ViewHolder holder, Assess assess) {
				...
				SimpleAdapter adapt = new SimpleAdapter(AssessListActivity.this, assess.getImglist(), 
